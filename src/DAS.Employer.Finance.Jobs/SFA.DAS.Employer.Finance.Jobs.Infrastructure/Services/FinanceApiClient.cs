...

{
    ...
    public FinanceApiClient(IHttpClientFactory httpClientFactory,IAzureClientCredentialHelper credentialHelper, FinanceApiConfiguration configuration,ILogger<FinanceApiClient> logger)
    ...
    public async Task<ApiResponse<TResponse>> GetWithResponseCode<TResponse>(IGetApiRequest request)
    {
        ...
        return new ApiResponse<TResponse>
        {
            ...
            Body = response.IsSuccessStatusCode ? JsonSerializer.Deserialize<TResponse>(content, _jsonOptions): default(TResponse)
        };
    }
}
