...
public class WhenConstructingPaymentApiClient
{
    private Mock<IHttpClientFactory> _mockHttpClientFactory;
    private Mock<IAzureClientCredentialHelper> _mockCredentialHelper;
    private PaymentApiConfiguration _validConfiguration;
    private Mock<ILogger<PaymentApiClient>> _mockLogger;
    ...
    public void SetUp()
    {
        ...
        _validConfiguration = new PaymentApiConfiguration
        {
            Url = "https://payment-api.test.local",
            Identifier = "payment-api-id"
        };
        _mockLogger = new Mock<ILogger<PaymentApiClient>>();
    }
    ...
    {
        // Act & Assert
        var act = () => new PaymentApiClient(null!, _mockCredentialHelper.Object, _validConfiguration, _mockLogger.Object);
    ...
    {
        // Act & Assert
        var act = () => new PaymentApiClient(_mockHttpClientFactory.Object, null!, _validConfiguration, _mockLogger.Object);
        act.Should().Throw<ArgumentNullException>()
    ...
    {
        // Act & Assert
        var act = () => new PaymentApiClient(_mockHttpClientFactory.Object, _mockCredentialHelper.Object, null!, _mockLogger.Object);
        act.Should().Throw<ArgumentNullException>()
    ...
    {
        // Act & Assert
        var act = () => new PaymentApiClient(_mockHttpClientFactory.Object, _mockCredentialHelper.Object, _validConfiguration, null!);
        act.Should().Throw<ArgumentNullException>()
    ...
    {
        // Act
        var act = () => new PaymentApiClient(_mockHttpClientFactory.Object, _mockCredentialHelper.Object, _validConfiguration, _mockLogger.Object);
    ...
    {
        // Act
        var client = new PaymentApiClient(_mockHttpClientFactory.Object, _mockCredentialHelper.Object, _validConfiguration, _mockLogger.Object);
